...
public class Logger {
    ...
    public static void log(@NotNull Level currentLevel, @NotNull String message,
        ...
        if (logLevel.ordinal() < currentLevel.ordinal()) {
            loggerOutput.write(currentLevel, formatter.format(currentLevel, String.format(message, args)));
        }
    }
    ...
    public static void setFormatter(@NotNull LogFormatter formatter) {
