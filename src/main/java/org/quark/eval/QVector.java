...
public final class QVector implements QSequence {

    private final ArrayList<QExpr> values;

    public QVector(ArrayList<QExpr> exprs) {
        this.values = exprs;
    }

    public QVector(QExpr... exprs) {
        this.values = new ArrayList<>(exprs.length);
