...
public class BuiltinUtils {
    ...
    public static void requireArity(@NotNull List<QExpr> args, int arity) {
        if (args.size() != arity) {
    ...
    public static void requireArityAtLeast(@NotNull List<QExpr> args,
                                           int arity) {
    ...
    public static void requireArgType(@NotNull List<QExpr> args, int arg
            , @NotNull Class<? extends QExpr> clazz) {
